...
arch-common-objs-$(CONFIG_ARCH_GENERIC_DEFTERM)+=generic_default_terminal.o
arch-common-objs-$(CONFIG_ARCH_GENERIC_DEFTERM_EARLY)+=generic_default_terminal_early.o
arch-common-objs-$(CONFIG_ARCH_GENERIC_DEVTREE)+=generic_device_tree.o
