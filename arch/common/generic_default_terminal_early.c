 ...
 *
 * @file generic_default_terminal_early.c
...
uint8_t      __aligned(VMM_PAGE_SIZE) default_terminal_early_base[VMM_PAGE_SIZE];
static void *early_base = &default_terminal_early_base[CONFIG_ARCH_GENERIC_DEFTERM_EARLY_BASE_PA & VMM_PAGE_MASK];
 ...
 */
void __init arch_default_terminal_early_putc(uint8_t ch)
{
