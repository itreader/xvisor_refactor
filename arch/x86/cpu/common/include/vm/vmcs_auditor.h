...
#define BX_IA32_FEATURE_CONTROL_BITS           (BX_IA32_FEATURE_CONTROL_LOCK_BIT | BX_IA32_FEATURE_CONTROL_VMX_ENABLE_BIT)
...
#define IS_TRAP_LIKE_VMEXIT(reason) (reason == VMX_VMEXIT_TPR_THRESHOLD || reason == VMX_VMEXIT_VIRTUALIZED_EOI || reason == VMX_VMEXIT_APIC_WRITE)
...
#define VMCS_FIELD_INDEX(encoding)                         ((VMCS_FIELD_WIDTH(encoding) << 2) + VMCS_FIELD_TYPE(encoding))
...
#define VMX_VM_EXEC_CTRL1_SUPPORTED_BITS              (vmx_pin_vmexec_ctrl_supported_bits)
...
#define VMX_VM_EXEC_CTRL2_SUPPORTED_BITS          (vmx_proc_vmexec_ctrl_supported_bits)
...
#define VMX_VM_EXEC_CTRL3_SUPPORTED_BITS            (vmx_vmexec_ctrl2_supported_bits)
...
#define VMX_VMEXIT_CTRL1_SUPPORTED_BITS             (vmx_vmexit_ctrl_supported_bits)
...
#define VMX_VMENTRY_CTRL1_SUPPORTED_BITS                    (vmx_vmentry_ctrl_supported_bits)
...
#define VMX_VMFUNC_CTRL1_SUPPORTED_BITS (vmx_vmfunc_supported_bits)
...
#define VMX_MSR_VMX_PINBASED_CTRLS_HI       (VMX_VM_EXEC_CTRL1_SUPPORTED_BITS | VMX_MSR_VMX_PINBASED_CTRLS_LO)

#define VMX_MSR_VMX_PINBASED_CTRLS          ((((Bit64u)VMX_MSR_VMX_PINBASED_CTRLS_HI) << 32) | VMX_MSR_VMX_PINBASED_CTRLS_LO)
...
#define VMX_MSR_VMX_TRUE_PINBASED_CTRLS     ((((Bit64u)VMX_MSR_VMX_TRUE_PINBASED_CTRLS_HI) << 32) | VMX_MSR_VMX_TRUE_PINBASED_CTRLS_LO)
...
// Allowed 1-settings
#define VMX_MSR_VMX_PROCBASED_CTRLS_HI      (VMX_VM_EXEC_CTRL2_SUPPORTED_BITS | VMX_MSR_VMX_PROCBASED_CTRLS_LO)

#define VMX_MSR_VMX_PROCBASED_CTRLS         ((((Bit64u)VMX_MSR_VMX_PROCBASED_CTRLS_HI) << 32) | VMX_MSR_VMX_PROCBASED_CTRLS_LO)
...
#define VMX_MSR_VMX_TRUE_PROCBASED_CTRLS    ((((Bit64u)VMX_MSR_VMX_TRUE_PROCBASED_CTRLS_HI) << 32) | VMX_MSR_VMX_TRUE_PROCBASED_CTRLS_LO)
...
// Allowed 1-settings
#define VMX_MSR_VMX_VMEXIT_CTRLS_HI         (VMX_VMEXIT_CTRL1_SUPPORTED_BITS | VMX_MSR_VMX_VMEXIT_CTRLS_LO)

#define VMX_MSR_VMX_VMEXIT_CTRLS            ((((Bit64u)VMX_MSR_VMX_VMEXIT_CTRLS_HI) << 32) | VMX_MSR_VMX_VMEXIT_CTRLS_LO)
...
#define VMX_MSR_VMX_TRUE_VMEXIT_CTRLS       ((((Bit64u)VMX_MSR_VMX_TRUE_VMEXIT_CTRLS_HI) << 32) | VMX_MSR_VMX_TRUE_VMEXIT_CTRLS_LO)
...
// Allowed 1-settings
#define VMX_MSR_VMX_VMENTRY_CTRLS_HI        (VMX_VMENTRY_CTRL1_SUPPORTED_BITS | VMX_MSR_VMX_VMENTRY_CTRLS_LO)

#define VMX_MSR_VMX_VMENTRY_CTRLS           ((((Bit64u)VMX_MSR_VMX_VMENTRY_CTRLS_HI) << 32) | VMX_MSR_VMX_VMENTRY_CTRLS_LO)
...
#define VMX_MSR_VMX_TRUE_VMENTRY_CTRLS      ((((Bit64u)VMX_MSR_VMX_TRUE_VMENTRY_CTRLS_HI) << 32) | VMX_MSR_VMX_TRUE_VMENTRY_CTRLS_LO)
...
#define VMX_MSR_CR0_FIXED0              ((((Bit64u)VMX_MSR_CR0_FIXED0_HI) << 32) | VMX_MSR_CR0_FIXED0_LO)

// allowed 1-setting in CR0 in VMX mode
#define VMX_MSR_CR0_FIXED1_LO           (0xFFFFFFFF)
#define VMX_MSR_CR0_FIXED1_HI           (0x00000000)

#define VMX_MSR_CR0_FIXED1              ((((Bit64u)VMX_MSR_CR0_FIXED1_HI) << 32) | VMX_MSR_CR0_FIXED1_LO)
...
#define VMX_MSR_CR4_FIXED0              ((((Bit64u)VMX_MSR_CR4_FIXED0_HI) << 32) | VMX_MSR_CR4_FIXED0_LO)

// allowed 1-setting in CR0 in VMX mode
#define VMX_MSR_CR4_FIXED1_LO           (cr4_suppmask_1)
#define VMX_MSR_CR4_FIXED1_HI           (0)

#define VMX_MSR_CR4_FIXED1              ((((Bit64u)VMX_MSR_CR4_FIXED1_HI) << 32) | VMX_MSR_CR4_FIXED1_LO)
...
#define VMX_MSR_VMCS_ENUM               ((((Bit64u)VMX_MSR_VMCS_ENUM_HI) << 32) | VMX_MSR_VMCS_ENUM_LO)
...
// Allowed 1-settings
#define VMX_MSR_VMX_PROCBASED_CTRLS2_HI (VMX_VM_EXEC_CTRL3_SUPPORTED_BITS | VMX_MSR_VMX_PROCBASED_CTRLS2_LO)

#define VMX_MSR_VMX_PROCBASED_CTRLS2    ((((Bit64u)VMX_MSR_VMX_PROCBASED_CTRLS2_HI) << 32) | VMX_MSR_VMX_PROCBASED_CTRLS2_LO)
...
#define VMX_MSR_VMX_EPT_VPID_CAP (BX_CPU_THIS_PTR vmx_cap.vmx_ept_vpid_cap_supported_bits)
...
#define VMX_CHECKS_USE_MSR_VMX_PINBASED_CTRLS_LO     ((BX_SUPPORT_VMX >= 2) ? VMX_MSR_VMX_TRUE_PINBASED_CTRLS_LO : VMX_MSR_VMX_PINBASED_CTRLS_LO)
#define VMX_CHECKS_USE_MSR_VMX_PINBASED_CTRLS_HI     ((BX_SUPPORT_VMX >= 2) ? VMX_MSR_VMX_TRUE_PINBASED_CTRLS_HI : VMX_MSR_VMX_PINBASED_CTRLS_HI)

#define VMX_CHECKS_USE_MSR_VMX_PROCBASED_CTRLS_LO    ((BX_SUPPORT_VMX >= 2) ? VMX_MSR_VMX_TRUE_PROCBASED_CTRLS_LO : VMX_MSR_VMX_PROCBASED_CTRLS_LO)
#define VMX_CHECKS_USE_MSR_VMX_PROCBASED_CTRLS_HI    ((BX_SUPPORT_VMX >= 2) ? VMX_MSR_VMX_TRUE_PROCBASED_CTRLS_HI : VMX_MSR_VMX_PROCBASED_CTRLS_HI)

#define VMX_CHECKS_USE_MSR_VMX_VMEXIT_CTRLS_LO       ((BX_SUPPORT_VMX >= 2) ? VMX_MSR_VMX_TRUE_VMEXIT_CTRLS_LO : VMX_MSR_VMX_VMEXIT_CTRLS_LO)
#define VMX_CHECKS_USE_MSR_VMX_VMEXIT_CTRLS_HI       ((BX_SUPPORT_VMX >= 2) ? VMX_MSR_VMX_TRUE_VMEXIT_CTRLS_HI : VMX_MSR_VMX_VMEXIT_CTRLS_HI)
...
#define VMX_CHECKS_USE_MSR_VMX_VMENTRY_CTRLS_HI      ((BX_SUPPORT_VMX >= 2) ? VMX_MSR_VMX_TRUE_VMENTRY_CTRLS_HI : VMX_MSR_VMX_VMENTRY_CTRLS_HI)
...
#define BX_INHIBIT_INTERRUPTS_BY_MOVSS (BX_INHIBIT_INTERRUPTS | BX_INHIBIT_DEBUG)
...
#define BX_CPU_CALL_METHOD(func, args)        ((BxExecutePtr_tR)(func)) args
#define BX_CPU_CALL_REP_ITERATION(func, args) ((BxRepIterationPtr_tR)(func)) args
...
#define BX_SUPPORT_VMX_EXTENSION(feature_mask) (vmx_extensions_bitmask & (feature_mask))

#define BX_SUPPORT_SVM_EXTENSION(feature_mask) (BX_CPU_THIS_PTR svm_extensions_bitmask & (feature_mask))
...
BOOLEAN CheckVMXState(
    VMCS_CACHE *pVm, BOOLEAN IsVMResume, UINT64 VMXON_Pointer, INT32 RevisionID, UINT32 _vmx_pin_vmexec_ctrl_supported_bits,
    UINT32 _vmx_proc_vmexec_ctrl_supported_bits, UINT32 _vmx_vmexec_ctrl2_supported_bits, UINT32 _vmx_vmexit_ctrl_supported_bits,
    UINT32 _vmx_vmentry_ctrl_supported_bits, UINT64 _vmx_ept_vpid_cap_supported_bits, UINT64 _vmx_vmfunc_supported_bits, UINT32 _cr0_suppmask_0,
    UINT32 _cr0_suppmask_1, UINT32 _cr4_suppmask_0, UINT32 _cr4_suppmask_1);
