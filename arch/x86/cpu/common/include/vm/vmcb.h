...
struct vmcb {
    ...
    uint32_t   res06;                /* offset 0x38 */
    uint16_t   res06a;               /* offset 0x3C */
    uint16_t   pause_filter_count;   /* offset 0x3E */
    ...
    uint64_t   np_enable;            /* offset 0x90 */
    uint64_t   res08[2];
    eventinj_t eventinj;             /* offset 0xA8 */
    uint64_t   n_cr3;                /* offset 0xB0 */
    lbrctrl_t  lbr_control;          /* offset 0xB8 */
    uint64_t   res09;                /* offset 0xC0 */
    uint64_t   nextrip;              /* offset 0xC8 */
    uint64_t   res10a[102];          /* offset 0xD0 pad to save area */
    ...
    uint64_t            pdpe3;
    uint64_t            g_pat;
    uint64_t            debugctlmsr;
    uint64_t            lastbranchfromip;
    uint64_t            lastbranchtoip;
    uint64_t            lastintfromip;
    uint64_t            lastinttoip;
    uint64_t            res16[301];
} __packed;
