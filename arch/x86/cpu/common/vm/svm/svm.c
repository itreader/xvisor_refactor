...
static virtual_addr_t alloc_host_save_area(void)
{
    ...
    virtual_addr_t hsa = vmm_host_alloc_pages(NR_SAVE_AREA_PAGES, VMM_MEMORY_FLAGS_NORMAL);
...
static struct vmcb *alloc_vmcb(void)
{
    ...
    vmcb = (struct vmcb *)vmm_host_alloc_pages(NR_SAVE_AREA_PAGES, VMM_MEMORY_FLAGS_NORMAL);
...
static void set_control_params(struct vcpu_hw_context *context)
{
    ...
    vmcb->cr_intercepts |=
        (INTRCPT_WRITE_CR3 | INTRCPT_READ_CR3 | INTRCPT_WRITE_CR0 | INTRCPT_READ_CR0 | INTRCPT_WRITE_CR2 | INTRCPT_READ_CR2 | INTRCPT_WRITE_CR1 |
         INTRCPT_READ_CR1 | INTRCPT_WRITE_CR4 | INTRCPT_READ_CR4);
    ...
    vmcb->general1_intercepts |=
        (INTRCPT_INTR | INTRCPT_VINTR | INTRCPT_CR0_WR | INTRCPT_CPUID | INTRCPT_IOIO_PROT | INTRCPT_MSR_PROT | INTRCPT_TASKSWITCH |
         INTRCPT_SHUTDOWN | INTRCPT_INVLPG | INTRCPT_INVLPGA | INTRCPT_HLT);

    vmcb->exception_intercepts |=
        (INTRCPT_EXC_DIV_ERR | INTRCPT_EXC_DB | INTRCPT_EXC_NMI | INTRCPT_EXC_BP | INTRCPT_EXC_OV | INTRCPT_EXC_BOUNDS | INTRCPT_EXC_INV_OPC |
         INTRCPT_EXC_NDEV | INTRCPT_EXC_DFAULT | INTRCPT_EXC_CP_OVRRUN | INTRCPT_EXC_INV_TSS | INTRCPT_EXC_SEG_NP | INTRCPT_EXC_NO_STK_SEG |
         INTRCPT_EXC_GPF | INTRCPT_EXC_PF);
...
static void svm_run(struct vcpu_hw_context *context)
{
    ...
    asm volatile(
        ...
        "pop %%rbp\n\t"
        :
        : [context] "a"(context), [vmcb] "i"(offsetof(struct vcpu_hw_context, vmcb_pa)),
          [rbx] "i"(offsetof(struct vcpu_hw_context, g_regs[GUEST_REGS_RBX])), [rcx] "i"(offsetof(struct vcpu_hw_context, g_regs[GUEST_REGS_RCX])),
          [rdx] "i"(offsetof(struct vcpu_hw_context, g_regs[GUEST_REGS_RDX])), [rsi] "i"(offsetof(struct vcpu_hw_context, g_regs[GUEST_REGS_RSI])),
          [rdi] "i"(offsetof(struct vcpu_hw_context, g_regs[GUEST_REGS_RDI])), [rbp] "i"(offsetof(struct vcpu_hw_context, g_regs[GUEST_REGS_RBP])),
          [r8] "i"(offsetof(struct vcpu_hw_context, g_regs[GUEST_REGS_R8])), [r9] "i"(offsetof(struct vcpu_hw_context, g_regs[GUEST_REGS_R9])),
          [r10] "i"(offsetof(struct vcpu_hw_context, g_regs[GUEST_REGS_R10])), [r11] "i"(offsetof(struct vcpu_hw_context, g_regs[GUEST_REGS_R11])),
          [r12] "i"(offsetof(struct vcpu_hw_context, g_regs[GUEST_REGS_R12])), [r13] "i"(offsetof(struct vcpu_hw_context, g_regs[GUEST_REGS_R13])),
          [r14] "i"(offsetof(struct vcpu_hw_context, g_regs[GUEST_REGS_R14])), [r15] "i"(offsetof(struct vcpu_hw_context, g_regs[GUEST_REGS_R15]))
        : "cc", "memory", "rbx", "rcx", "rdx", "rsi", "rdi", "r8", "r9", "r10", "r11", "r12", "r13", "r14", "r15");
...
static int enable_svm(struct cpuinfo_x86 *c)
{
    ...
    if (!c->hw_nested_paging) {
        X86_DEBUG_LOG(
            svm, LVL_INFO,
            "Nested pagetables are not supported.\n"
