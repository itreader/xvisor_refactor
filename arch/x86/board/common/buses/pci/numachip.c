...
static uint8_t limit __read_mostly;

static inline char __iomem *pci_dev_base(uint32_t seg, uint32_t bus, uint32_t devfn)
{
...
static int pci_mmcfg_read_numachip(uint32_t seg, uint32_t bus, uint32_t devfn, int reg, int len, uint32_t *value)
{
    char __iomem *addr;
...
static int pci_mmcfg_write_numachip(uint32_t seg, uint32_t bus, uint32_t devfn, int reg, int len, uint32_t value)
{
    char __iomem *addr;
