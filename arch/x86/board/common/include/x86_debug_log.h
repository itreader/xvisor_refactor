...
#define DECLARE_X86_DEBUG_LOG_SUBSYS_LEVEL(subsys)     int vmm_debug_##subsys##_log_lvl

#define DEFINE_X86_DEBUG_LOG_SUBSYS_LEVEL(subsys, lvl) DECLARE_X86_DEBUG_LOG_SUBSYS_LEVEL(subsys) __read_mostly = lvl
