 ...
 * @brief RISC-V specific function stack_trace.
 */
...
void arch_save_stack_trace(struct stack_trace *trace)
{
    ...
    frame.sp    = current_sp;
    frame.ll.fp = (uint64_t)__builtin_frame_address(0);
    frame.ll.ra = (uint64_t)arch_save_stack_trace + 0x4;
