...
#define riscv_isa_extension_available(isa_bitmap, ext) __riscv_isa_extension_available(isa_bitmap, RISCV_ISA_EXT_##ext)
...
/** RISC-V XLEN */
extern uint64_t riscv_xlen;

/** RISC-V Stage2 MMU mode */
extern uint64_t riscv_stage2_mode;

/** RISC-V Stage2 VMID bits */
extern uint64_t riscv_stage2_vmid_bits;

/** RISC-V Stage2 VMID nested */
extern uint64_t riscv_stage2_vmid_nested;

/** RISC-V Stage2 VMID available for Guest */
#define riscv_stage2_vmid_available() (CONFIG_MAX_GUEST_COUNT <= riscv_stage2_vmid_nested)

/** RISC-V Time Base Frequency */
extern uint64_t riscv_timer_hz;
