...
static inline void __raw_write8(volatile void *addr, uint8_t val)
{
    asm volatile("sb %0, 0(%1)" : : "r"(val), "r"(addr));
}

static inline void __raw_write16(volatile void *addr, uint16_t val)
{
    asm volatile("sh %0, 0(%1)" : : "r"(val), "r"(addr));
}

static inline void __raw_write32(volatile void *addr, uint32_t val)
{
    asm volatile("sw %0, 0(%1)" : : "r"(val), "r"(addr));
}

static inline void __raw_write64(volatile void *addr, uint64_t val)
{
    asm volatile("sd %0, 0(%1)" : : "r"(val), "r"(addr));
}

static inline uint8_t __raw_read8(const volatile void *addr)
{
    uint8_t val;
...
static inline uint16_t __raw_read16(const volatile void *addr)
{
    uint16_t val;
...
static inline uint32_t __raw_read32(const volatile void *addr)
{
    uint32_t val;
...
static inline uint64_t __raw_read64(const volatile void *addr)
{
    uint64_t val;
