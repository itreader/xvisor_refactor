...
#define INSN_IS_32BIT(insn)            (((insn) & INSN_16BIT_MASK) == INSN_16BIT_MASK && ((insn) & INSN_32BIT_MASK) != INSN_32BIT_MASK)
...
#define REG_MASK                 ((1 << (5 + LOG_REGBYTES)) - (1 << LOG_REGBYTES))

#define REG_OFFSET(insn, pos)    (SHIFT_RIGHT((insn), (pos) - LOG_REGBYTES) & REG_MASK)
...
#define INSN_GET_C_LWSP_IMM(insn)         (((((insn) >> 4) & 0x7) << 2) | ((((insn) >> 12) & 0x1) << 5) | ((((insn) >> 2) & 0x3) << 6))
#define INSN_GET_C_LDSP_IMM(insn)         (((((insn) >> 5) & 0x3) << 3) | ((((insn) >> 12) & 0x1) << 5) | ((((insn) >> 2) & 0x7) << 6))
#define INSN_GET_C_SWSP_IMM(insn)         (((((insn) >> 9) & 0xf) << 2) | ((((insn) >> 7) & 0x3) << 6))
#define INSN_GET_C_SDSP_IMM(insn)         (((((insn) >> 10) & 0x7) << 3) | ((((insn) >> 7) & 0x7) << 6))

#define INSN_GET_C_LW_IMM(inss)           (((((insn) >> 6) & 0x1) << 2) | ((((insn) >> 10) & 0x7) << 3) | ((((insn) >> 5) & 0x1) << 6))
#define INSN_GET_C_LD_IMM(insn)           (((((insn) >> 10) & 0x7) << 3) | ((((insn) >> 5) & 0x3) << 6))
