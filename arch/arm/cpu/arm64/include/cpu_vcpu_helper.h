 ...
 *  of ARM instructions
 */
uint64_t cpu_vcpu_reg64_read(vmm_vcpu_t *vcpu, arch_regs_t *regs, uint32_t reg_num);
 ...
 *  of ARM instructions
 */
void cpu_vcpu_reg64_write(vmm_vcpu_t *vcpu, arch_regs_t *regs, uint32_t reg_num, uint64_t reg_val);
 ...
 *  of ARM instructions
 */
uint64_t cpu_vcpu_reg_read(vmm_vcpu_t *vcpu, arch_regs_t *regs, uint32_t reg_num);
 ...
 *  of ARM instructions
 */
void cpu_vcpu_reg_write(vmm_vcpu_t *vcpu, arch_regs_t *regs, uint32_t reg_num, uint64_t reg_val);
