...
#define CPSR_NZCV_MASK                       (CPSR_NEGATIVE_MASK | CPSR_ZERO_MASK | CPSR_CARRY_MASK | CPSR_OVERFLOW_MASK)
#define CPSR_IT_MASK                         (CPSR_IT2_MASK | CPSR_IT1_MASK)
#define CPSR_USERBITS_MASK                   (CPSR_NZCV_MASK | CPSR_CUMMULATE_MASK | CPSR_GE_MASK | CPSR_IT_MASK | CPSR_THUMB_ENABLED)
