...
void invalidate_icache_line(uint32_t line);
...
void invalidate_dcache_line(uint32_t line);
...
void invalidate_idcache_line(uint32_t line);
...
void clean_dcache_line(uint32_t line);
...
void clean_idcache_line(uint32_t line);
...
void clean_invalidate_dcache_line(uint32_t line);
...
void clean_invalidate_idcache_line(uint32_t line);
