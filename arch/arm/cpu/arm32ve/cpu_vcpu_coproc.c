...
static bool cpu_vcpu_cpx_read_zero(vmm_vcpu_t *vcpu, arch_regs_t *regs, uint32_t opc1, uint32_t opc2, uint32_t CRn, uint32_t CRm, uint32_t *data)
{
    *data = 0x0;
    return TRUE;
}

static bool cpu_vcpu_cpx_ignore_write(vmm_vcpu_t *vcpu, arch_regs_t *regs, uint32_t opc1, uint32_t opc2, uint32_t CRn, uint32_t CRm, uint32_t data)
{
    return TRUE;
}
