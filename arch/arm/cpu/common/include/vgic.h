...
struct vgic_ops {
    void (*reset_state)(struct vgic_hw_state *state, enum vgic_model_type model);
    void (*save_state)(struct vgic_hw_state *state, enum vgic_model_type model);
    void (*restore_state)(struct vgic_hw_state *state, enum vgic_model_type model);
