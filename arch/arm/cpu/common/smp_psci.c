 ...
 * @brief PSCI CPU management support
 *
...
static int __init psci_smp_init(vmm_device_tree_node_t *node, uint32_t cpu)
{
    /* Nothing to do here. */
    return VMM_OK;
}

static int __init psci_smp_prepare(uint32_t cpu)
{
    /* Nothing to do here. */
    return VMM_OK;
}
...
static int __init psci_smp_boot(uint32_t cpu)
{
    int             rc;
