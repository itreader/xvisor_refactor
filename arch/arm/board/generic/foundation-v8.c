...
static int __init foundation_v8_early_init(vmm_device_tree_node_t *node)
{
    /* Setup CLCD (before probing) */
    node = vmm_device_tree_find_compatible(NULL, NULL, "arm,pl111");
...
static int __init foundation_v8_final_init(vmm_device_tree_node_t *node)
{
    /* Nothing to do here. */
    return VMM_OK;
}
