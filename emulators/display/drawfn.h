...
#define DRAWFN_FNTABLE_INDEX(format, order, bppmode) ((format) * (DRAWFN_ORDER_MAX * DRAWFN_BPPMODE_MAX) + (order) * DRAWFN_BPPMODE_MAX + (bppmode))

#define DRAWFN_FNTABLE_SIZE                          (DRAWFN_BPPMODE_MAX * DRAWFN_ORDER_MAX * DRAWFN_FORMAT_MAX)
