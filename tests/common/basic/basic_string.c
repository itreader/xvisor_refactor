...
void *basic_memcpy(void *dest, const void *src, uint32_t count)
{
...
void *basic_memmove(void *dest, const void *src, uint32_t count)
{
    uint8_t       *dst8 = (uint8_t *)dest;
...
void *basic_memset(void *dest, int c, uint32_t count)
{
    uint8_t *dst8 = (uint8_t *)dest;
...
int basic_memcmp(const void *s1, const void *s2, uint32_t count)
{
...
void basic_ulonglong2str(char *dst, uint64_t src)
{
    uint64_t          r;
    uint64_t          val, remainder;
    int               count = 0, pos = 0;
    static const char intchars[] = "0123456789";
...
uint32_t basic_hexstr2uint(char *src)
{
    uint32_t val = 0x0;
    int      pos = 0;
...
uint64_t basic_hexstr2ulonglong(char *src)
{
    uint64_t val = 0x0;
    int      pos = 0;
...
void basic_uint2hexstr(char *dst, uint32_t src)
{
    int               ite, pos = 0;
...
void basic_ulonglong2hexstr(char *dst, uint64_t src)
{
    int               ite, pos = 0;
    static const char hexchars[] = "0123456789ABCDEF";
