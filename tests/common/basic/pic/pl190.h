...
int pl190_active_irq(uint32_t vic_nr);
int pl190_eoi_irq(uint32_t vic_nr, uint32_t irq);
int pl190_mask(uint32_t vic_nr, uint32_t irq);
int pl190_unmask(uint32_t vic_nr, uint32_t irq);
int pl190_cpu_init(uint32_t vic_nr, virtual_addr_t base);
