...
TimeStamp Begin_Time, End_Time, User_Time;
...
/* Main and Proc_0 in the Ada version             */
{
    ...
    dhry_strcpy(Ptr_Glob->variant.var_1.Str_Comp, "DHRYSTONE PROGRAM, SOME STRING");
    ...
    dhry_printl((uint64_t)Ptr_Glob->Ptr_Comp);
    dhry_prints("\n");
    ...
    dhry_prints("  Ptr_Comp:          ");
    dhry_printl((uint64_t)Next_Ptr_Glob->Ptr_Comp);
    dhry_prints("\n");
