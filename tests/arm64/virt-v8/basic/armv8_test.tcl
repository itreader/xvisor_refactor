...
send -- "host virtual_address_pool stats\r"
expect $xvisor_prompt
...
send -- "device_tree help\r"
expect $xvisor_prompt
set device_tree_help_out $expect_out(buffer)
if { [string first "device_tree print" $device_tree_help_out] > -1 } {
        puts "\n :: DEVTREE HELP TESTCASE PASS :: \n\n"
} else {
        puts "\n :: DEVTREE HELP TESTCASE FAIL :: \n\n"
}

send -- "device_tree node show /\r"
expect $xvisor_prompt
set device_tree_node_show_out $expect_out(buffer)
if { [string first "vmm" $device_tree_node_show_out] > -1 } {
        puts "\n :: DEVTREE NODE SHOW TESTCASE PASS :: \n\n"
} else {
        puts "\n :: DEVTREE NODE SHOW TESTCASE FAIL :: \n\n"
}

send -- "device_tree node dump /\r"
expect $xvisor_prompt
set device_tree_node_dump_out $expect_out(buffer)
if { [string first "vmm" $device_tree_node_dump_out] > -1 } {
