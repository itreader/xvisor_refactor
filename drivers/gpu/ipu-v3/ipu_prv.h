...
struct ipu_soc {
    ...
    /*clk*/
    struct clk *ipu_clock;
    struct clk *di_clock[2];
    struct clk *di_clock_sel[2];
    struct clk *pixel_clock[2];
    struct clk *pixel_clock_sel[2];
    struct clk *csi_clock[2];
    ...
    bool             color_key_4rgb;
    bool             dc_swap;
    vmm_completion_t dc_comp;
    vmm_completion_t csi_comp;
...
static inline void ipu_cm_write(struct ipu_soc *ipu, uint32_t value, unsigned offset)
{
...
static inline void ipu_idmac_write(struct ipu_soc *ipu, uint32_t value, unsigned offset)
{
...
static inline void ipu_dc_write(struct ipu_soc *ipu, uint32_t value, unsigned offset)
{
...
static inline void ipu_dc_tmpl_write(struct ipu_soc *ipu, uint32_t value, unsigned offset)
{
...
static inline void ipu_dmfc_write(struct ipu_soc *ipu, uint32_t value, unsigned offset)
{
...
static inline void ipu_dp_write(struct ipu_soc *ipu, uint32_t value, unsigned offset)
{
...
static inline void ipu_di_write(struct ipu_soc *ipu, int di, uint32_t value, unsigned offset)
{
...
static inline void ipu_csi_write(struct ipu_soc *ipu, int csi, uint32_t value, unsigned offset)
{
...
static inline void ipu_smfc_write(struct ipu_soc *ipu, uint32_t value, unsigned offset)
{
...
static inline void ipu_vdi_write(struct ipu_soc *ipu, uint32_t value, unsigned offset)
{
...
static inline void ipu_ic_write(struct ipu_soc *ipu, uint32_t value, unsigned offset)
{
...
void ipu_csi_set_test_generator(
...
struct clk *clock_register_mux_pix_clock(
    vmm_device_t *dev, const char *name, const char **parent_names, uint8_t num_parents, uint64_t flags, uint8_t ipu_id, uint8_t di_id,
    uint8_t clock_mux_flags);
struct clk *clock_register_div_pix_clock(
    vmm_device_t *dev, const char *name, const char *parent_name, uint64_t flags, uint8_t ipu_id, uint8_t di_id, uint8_t clock_div_flags);
struct clk *clock_register_gate_pix_clock(
    vmm_device_t *dev, const char *name, const char *parent_name, uint64_t flags, uint8_t ipu_id, uint8_t di_id, uint8_t clock_gate_flags);
