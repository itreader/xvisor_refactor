...
static const struct clock_icst_desc __initdata versatile_osc4_desc = {
...
/*
 * versatile_clock_init() - set up the Versatile clock tree
 */
void __init versatile_clock_init(void *sysbase)
{
    struct clk *clk;

    /* ICST VCO clock */
    clk = icst_clock_register(NULL, &versatile_osc4_desc, "osc4", NULL, sysbase);
