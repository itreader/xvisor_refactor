...
VMM_EXPORT_SYMBOL(of_clock_get);
...
VMM_EXPORT_SYMBOL(of_clock_get_by_name);
...
VMM_EXPORT_SYMBOL(clock_get_sys);
...
VMM_EXPORT_SYMBOL(clock_add_alias);
...
VMM_EXPORT_SYMBOL(clock_register_clockdev);
...
VMM_EXPORT_SYMBOL(clock_hw_register_clockdev);
