...
struct reset_control *devm_reset_control_get(struct device *dev, const char *id)
{
    ...
    ptr = device_resource_alloc(devm_reset_control_release, sizeof(*ptr), GFP_KERNEL);
...
VMM_DECLARE_MODULE2(reset, "Reset controller support", "Jimmy Durand Wesolowski", "GPL", RESET_CONTROLLER_IPRIORITY, NULL, NULL);
