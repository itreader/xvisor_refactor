...
int pinctrl_bind_pins(struct device *dev)
{
    ...
    pins->default_state = pinctrl_lookup_state(pins->p, PINCTRL_STATE_DEFAULT);
     ...
     */
    pins->sleep_state = pinctrl_lookup_state(pins->p, PINCTRL_STATE_SLEEP);
    ...
    pins->idle_state = pinctrl_lookup_state(pins->p, PINCTRL_STATE_IDLE);
