...
struct vexpress_config_bridge_info {
    const char *name;
    void *(*func_get)(vmm_device_t *dev, vmm_device_tree_node_t *node);
    void (*func_put)(void *func);
    int (*func_exec)(void *func, int offset, bool write, uint32_t *data);
};
...
struct clk *vexpress_osc_setup(vmm_device_t *dev);
void        vexpress_osc_of_setup(vmm_device_tree_node_t *node);

void vexpress_clock_init(void *sp810_base);
void vexpress_clock_of_init(void);
