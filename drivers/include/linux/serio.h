...
struct serio {
    ...
    struct serio *parent;
    list_head_t   child_node;       /* Entry in parent->children list */
    list_head_t   children;
    uint32_t      depth;            /* level of nesting in serio hierarchy */
...
struct serio_driver {
    ...
    irqreturn_t (*interrupt)(struct serio *, unsigned char, uint32_t);
...
irqreturn_t serio_interrupt(struct serio *serio, unsigned char data, uint32_t flags);
