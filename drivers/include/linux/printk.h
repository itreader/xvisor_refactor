...
#define pr_emerg(fmt, ...)   vmm_lemergency(NULL, pr_fmt(fmt), ##__VA_ARGS__)
#define pr_alert(fmt, ...)   vmm_lalert(NULL, pr_fmt(fmt), ##__VA_ARGS__)
#define pr_crit(fmt, ...)    vmm_lcritical(NULL, pr_fmt(fmt), ##__VA_ARGS__)
#define pr_err(fmt, ...)     vmm_lerror(NULL, pr_fmt(fmt), ##__VA_ARGS__)
#define pr_warning(fmt, ...) vmm_lwarning(NULL, pr_fmt(fmt), ##__VA_ARGS__)
#define pr_warn              pr_warning
#define pr_notice(fmt, ...)  vmm_lnotice(NULL, pr_fmt(fmt), ##__VA_ARGS__)
#define pr_info(fmt, ...)    vmm_linfo(NULL, pr_fmt(fmt), ##__VA_ARGS__)
#define pr_cont(fmt, ...)    vmm_printf(pr_fmt(fmt), ##__VA_ARGS__)
...
#define pr_err_once(msg...) vmm_lerror_once(NULL, msg)
