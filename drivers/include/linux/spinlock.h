...
#define raw_spin_lock_irq_save      vmm_spin_lock_irq_save
#define raw_spin_unlock_irq_restore vmm_spin_unlock_irq_restore
...
#define spin_lock_irq_save          vmm_spin_lock_irq_save
#define spin_trylock_irq_save       vmm_spin_trylock_irq_save
#define spin_unlock_irq_restore     vmm_spin_unlock_irq_restore
