...
#define blocking_notifier_chain_register(nc, nb)   vmm_blocking_notifier_register(nc, nb)
...
#define blocking_notifier_chain_unregister(nc, nb) vmm_blocking_notifier_unregister(nc, nb)
...
#define blocking_notifier_call_chain(nc, val, v)   vmm_blocking_notifier_call(nc, val, v)
