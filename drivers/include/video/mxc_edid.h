...
struct mxc_edid_cfg {
    ...
    uint8_t vsd_video_latency;
    uint8_t vsd_audio_latency;
    uint8_t vsd_I_video_latency;
    uint8_t vsd_I_audio_latency;

    uint8_t                   physical_address[4];
    uint8_t                   hdmi_vic[64];
    struct mxc_hdmi_3d_format hdmi_3d_format[64];
    uint16_t                  hdmi_3d_mask_all;
    uint16_t                  hdmi_3d_struct_all;
    uint32_t                  vsd_max_tmdsclock_rate;

    uint8_t max_channels;
    uint8_t sample_sizes;
