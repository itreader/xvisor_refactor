 ...
 */
#define ___constant_swab16(x) ((uint16_t)((((uint16_t)(x) & (uint16_t)0x00ffU) << 8) | (((uint16_t)(x) & (uint16_t)0xff00U) >> 8)))
...
#define ___constant_swahw32(x) ((uint32_t)((((uint32_t)(x) & (uint32_t)0x0000ffffUL) << 16) | (((uint32_t)(x) & (uint32_t)0xffff0000UL) >> 16)))

#define ___constant_swahb32(x) ((uint32_t)((((uint32_t)(x) & (uint32_t)0x00ff00ffUL) << 8) | (((uint32_t)(x) & (uint32_t)0xff00ff00UL) >> 8)))
 ...
 */
#define __swahw32(x) (__builtin_constant_p((uint32_t)(x)) ? ___constant_swahw32(x) : __fswahw32(x))
 ...
 */
#define __swahb32(x) (__builtin_constant_p((uint32_t)(x)) ? ___constant_swahb32(x) : __fswahb32(x))
