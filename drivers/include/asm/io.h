...
#define ioread8_rep(p, dst, count)   insb((uint64_t)(p), (dst), (count))
#define ioread16_rep(p, dst, count)  insw((uint64_t)(p), (dst), (count))
#define ioread32_rep(p, dst, count)  insl((uint64_t)(p), (dst), (count))

#define iowrite8_rep(p, src, count)  outsb((uint64_t)(p), (src), (count))
#define iowrite16_rep(p, src, count) outsw((uint64_t)(p), (src), (count))
#define iowrite32_rep(p, src, count) outsl((uint64_t)(p), (src), (count))
#else
