...
/*
 * @file uapi/linux/mxcframe_buffer.h
 *
...
struct mxcfb_loc_alpha {
    int      enable;
    int      alpha_in_pixel;
    uint64_t alpha_phy_addr0;
    uint64_t alpha_phy_addr1;
};
...
#define MXCFB_SET_LOC_ALP_BUF          _IOW('F', 0x27, uint64_t)
...
#define MXCFB_GET_WORK_BUFFER          _IOWR('F', 0x34, uint64_t)
#endif
