...
extern int pinctrl_bind_pins(vmm_device_t *dev);
extern int pinctrl_init_done(vmm_device_t *dev);
...
static inline int pinctrl_bind_pins(vmm_device_t *dev)
{
    return 0;
}

static inline int pinctrl_init_done(vmm_device_t *dev)
{
    return 0;
}
