...
#define USB_DEVICE_STAT_U1_ENABLED     2 /* transition into U1 state */
#define USB_DEVICE_STAT_U2_ENABLED     3 /* transition into U2 state */
#define USB_DEVICE_STAT_LTM_ENABLED    4 /* Latency tolerance messages */
