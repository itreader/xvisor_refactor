 ...
 */
struct reset_control_ops {
    int (*reset)(struct reset_controller_dev *rcdev, uint64_t id);
    int (*assert)(struct reset_controller_dev *rcdev, uint64_t id);
    int (*deassert)(struct reset_controller_dev *rcdev, uint64_t id);
};
...
struct reset_controller_dev {
    ...
    int (*of_xlate)(struct reset_controller_dev *rcdev, const struct vmm_device_tree_phandle_args *reset_spec);
    uint32_t nr_resets;
};
