...
extern const struct imsic_local_config *imsic_get_local_config(uint32_t cpu);
...
static inline const struct imsic_local_config *imsic_get_local_config(uint32_t cpu)
{
    return NULL;
}
