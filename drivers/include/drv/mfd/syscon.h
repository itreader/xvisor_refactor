...
extern struct regmap *syscon_node_to_regmap(vmm_device_tree_node_t *np);
extern struct regmap *syscon_regmap_lookup_by_compatible(const char *s);
extern struct regmap *syscon_regmap_lookup_by_pdevname(const char *s);
extern struct regmap *syscon_regmap_lookup_by_phandle(vmm_device_tree_node_t *np, const char *property);
#else
