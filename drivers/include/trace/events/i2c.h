...
#define trace_smbus_write(adapter, addr, flags, read_write, command, protocol, data)
#define trace_smbus_reply(adapter, addr, flags, read_write, command, protocol, data)
#define trace_smbus_result(adapter, addr, flags, read_write, command, protocol, res)
