...
static int __init vexpress_poweroff_driver_probe(vmm_device_t *dev)
{
...
static int __exit vexpress_poweroff_driver_remove(vmm_device_t *dev)
{
    /* Nothing to do here. */
    return VMM_OK;
}

static struct vmm_device_tree_nodeid vexpress_poweroff_devid_table[] = {
...
static vmm_driver_t vexpress_poweroff_driver = {
...
{
    return vmm_device_driver_register_driver(&vexpress_poweroff_driver);
}

static void __exit vexpress_poweroff_exit(void)
{
    vmm_device_driver_unregister_driver(&vexpress_poweroff_driver);
}
