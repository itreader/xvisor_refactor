...
static void bitfill_aligned(struct frame_buffer_info *p, uint64_t *dst, int dst_idx, uint64_t pat, unsigned n, int bits)
{
    uint64_t first, last;
 ...
 */
static void bitfill_aligned_rev(struct frame_buffer_info *p, uint64_t *dst, int dst_idx, uint64_t pat, unsigned n, int bits)
{
    uint64_t val = pat;
    uint64_t first, last;
...
void sys_fillrect(struct frame_buffer_info *p, const struct frame_buffer_fillrect *rect)
{
    ...
    if (!left) {
        void (*fill_op32)(struct frame_buffer_info *p, uint64_t *dst, int dst_idx, uint64_t pat, unsigned n, int bits) = NULL;
        ...
        switch (rect->rop) {
            ...
            default:
                vmm_printf("cframe_buffer_fillrect(): unknown rop, "
