 ...
 **
 **           CONFIG_CPU_LE   - Uses processor with little endian
 **                             addressing. Default is big endian.
 **                             Note: This is defined by menuconfig
 **
 ...
 **                             PRE_INC_PTRS option.
 **
 **           CONFIG_64BIT    - Compiles memcpy for 64 bit
 **                             architectures
 **                             Note: This is defined by menuconfig
 **
 **
 ** Best Settings:
 **
 ** Intel x86:        CONFIG_CPU_LE and INDEXED_COPY
 ** ARM:              TBD
