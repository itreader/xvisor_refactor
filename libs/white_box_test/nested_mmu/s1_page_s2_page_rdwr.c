...
static int s1_page_s2_page_rdwr_run(struct white_box_test *test, vmm_char_device_t *cdev, uint32_t test_hcpu)
{
    int                    rc = VMM_OK;
...
static struct white_box_test s1_page_s2_page_rdwr = {
