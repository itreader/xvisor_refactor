...
struct scsi_transport {
    ...
    int (*transport)(struct scsi_request *srb, struct scsi_transport *tr, void *private);
    int (*reset)(struct scsi_transport *tr, void *private);
    void (*info_fixup)(struct scsi_info *info, struct scsi_transport *tr, void *private);
};
