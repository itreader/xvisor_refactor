...
/* Provide "list_head_t" for linux compatibility */
 ...
 * @param new_node: New node that needs to be added to list.
 * @param head: List head after which the "new" node should be added.
 * @note Please note that new node is added after the head.
 */
static inline void list_add(double_list_t *new_node, double_list_t *head)
{
 ...
 * @param new_node: The new node to be added before tail.
 * @param tnode: The current tail node.
 * @note: Please note that new node is added before tail node.
 */
static inline void list_add_tail(double_list_t *new_node, double_list_t *tnode)
{
    __list_add(new_node, tnode->prev, tnode);
}

static inline void __list_del(double_list_t *prev, double_list_t *next)
{
    prev->next = next;
    next->prev = prev;
}

static inline void __list_del_entry(double_list_t *entry)
{
 ...
 */
static inline void list_del(double_list_t *entry)
{
    __list_del(entry->prev, entry->next);
...
static inline double_list_t *list_pop_tail(double_list_t *head)
{
    double_list_t *dnode = head->prev;
    list_del(head->prev);
    return dnode;
}

static inline double_list_t *list_pop(double_list_t *head)
{
    double_list_t *dnode = head->next;
    list_del(head->next);
    return dnode;
}

static inline double_list_t *list_first(double_list_t *head)
{
    return head->next;
}
 ...
 */
static inline void list_replace(double_list_t *old, double_list_t *new_node)
{
...
static inline void list_replace_init(double_list_t *old, double_list_t *new_node)
{
 ...
 */
static inline void list_del_init(double_list_t *entry)
{
 ...
 */
static inline void list_move(double_list_t *list, double_list_t *head)
{
 ...
 */
static inline void list_move_tail(double_list_t *list, double_list_t *head)
{
    __list_del_entry(list);
 ...
 */
static inline int list_is_first(const double_list_t *list, const double_list_t *head)
{
 ...
 * @head: the head of the list
 */
static inline int list_is_last(const double_list_t *list, const double_list_t *head)
{
 ...
 */
static inline int list_empty(const double_list_t *head)
{
 ...
 */
static inline int list_empty_careful(const double_list_t *head)
{
    double_list_t *next = head->next;
 ...
 * @head: the head of the list
 */
static inline void list_rotate_left(double_list_t *head)
{
    double_list_t *first;
 ...
 * @head: the list to test.
 */
static inline int list_is_singular(const double_list_t *head)
{
    return !list_empty(head) && (head->next == head->prev);
}

static inline void __list_cut_position(double_list_t *list, double_list_t *head, double_list_t *entry)
{
    double_list_t *new_first = entry->next;
    list->next               = head->next;
    list->next->prev         = list;
    list->prev               = entry;
    entry->next              = list;
 ...
 *
 */
static inline void list_cut_position(double_list_t *list, double_list_t *head, double_list_t *entry)
{
    if (list_empty(head)) {
        return;
    }
...
static inline void __list_splice(const double_list_t *list, double_list_t *prev, double_list_t *next)
{
    double_list_t *first = list->next;
    double_list_t *last  = list->prev;
 ...
 */
static inline void list_splice(const double_list_t *list, double_list_t *head)
{
    if (!list_empty(list)) {
 ...
 * @head: the place to add it in the first list.
 */
static inline void list_splice_tail(double_list_t *list, double_list_t *head)
{
    if (!list_empty(list)) {
 ...
 */
static inline void list_splice_init(double_list_t *list, double_list_t *head)
{
    if (!list_empty(list)) {
        __list_splice(list, head, head->next);
        INIT_LIST_HEAD(list);
 ...
 * The list at @list is reinitialised
 */
static inline void list_splice_tail_init(double_list_t *list, double_list_t *head)
{
    if (!list_empty(list)) {
        __list_splice(list, head->prev, head);
        INIT_LIST_HEAD(list);
 ...
 */
static inline void hlist_move_list(struct hlist_head *old, struct hlist_head *new_node)
{
