#ifndef __UNALIGNED_GENERIC_H
#define __UNALIGNED_GENERIC_H
        ...
        __builtin_choose_expr(                                                                                                                       \
            ...
            __builtin_choose_expr(                                                                                                                   \
                ...
                __builtin_choose_expr(                                                                                                               \
                    ...
                    __builtin_choose_expr(sizeof(*(ptr)) == 8, get_unaligned_le64((ptr)), __bad_unaligned_access_size()))));                         \
    }))
        ...
        __builtin_choose_expr(                                                                                                                       \
            ...
            __builtin_choose_expr(                                                                                                                   \
                ...
                __builtin_choose_expr(                                                                                                               \
                    ...
                    __builtin_choose_expr(sizeof(*(ptr)) == 8, get_unaligned_be64((ptr)), __bad_unaligned_access_size()))));                         \
    }))
